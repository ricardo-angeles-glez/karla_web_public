        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/music" className="text-gray-400 hover:text-primary">
                  Music
                </Link>
              </li>
              <li>
                <Link href="/tour" className="text-gray-400 hover:text-primary">
                  Tour
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/merch" className="text-gray-400 hover:text-primary">
                  Merchandise
                </Link>
              </li>
              <li>
